...
<!-- BANNER — profile.sh --live (additive). Generated by scripts/banner/generate.py. -->
<picture>
...
<a href="https://github.com/Marcelfedz">
  <img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=600&size=24&duration=2800&pause=900&color=4F8CC9&center=true&vCenter=true&width=760&lines=Marcel+Fern%C3%A1ndez+Serrano;AI+%26+Data+Science+Engineer;Agents%2C+harnesses+%26+skills+that+ship" alt="typing banner">
</a>
...
Hi, I'm **Marcel** — AI & Data Science Engineer at [RocaSalvatella](https://www.rocasalvatella.com), based between Sabadell and Barcelona.
I design and build agentic systems for clients, then turn what works into reusable harnesses, skills, and StartKits.

- 🏢 **AI & Data Science Engineer at RocaSalvatella** — agentic solutions, harnesses, and skills for client engagements, plus personal build/research on the side.
...
<img src="https://skillicons.dev/icons?i=py,ts,js,react,nextjs,fastapi,postgres,docker,azure,git,github,vscode&perline=6" alt="core stack">
...
<sub>Barcelona · <a href="https://marcelfedz.vercel.app/">marcelfedz.vercel.app</a></sub>
